...
class LightCurve2(object):
    ...
    def __init__(self, name):
        ...
        self.ebv_mw = result[12]
        self.ebv_mw_err = result[13]
        self.ebv_host = result[14] 
        self.ebv_host_err = result[15]
        self.quality = result[16]
        self.jdexpl = result[17]
        self.jdexpl_err = result[18]
        self.jd = {}
        self.apparent_mag = {}
